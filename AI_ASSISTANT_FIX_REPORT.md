...
***REMOVED******REMOVED*** Git Log

```
7ad61a0 fix(ai): propagate unified language setting to assistant (***REMOVED***ISSUE-3)
7aaeda0 fix(ai): trigger assistant on first click (***REMOVED***ISSUE-1 ***REMOVED***ISSUE-2)
```
