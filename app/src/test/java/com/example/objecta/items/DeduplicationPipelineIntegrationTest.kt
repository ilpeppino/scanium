...
class DeduplicationPipelineIntegrationTest {
    ...
    fun whenSameObjectDetectedWithChangingTrackingIds_thenDeduplicatedCorrectly() = runTest {
        ...
        var allConfirmed = mutableListOf<com.example.objecta.tracking.ObjectCandidate>()
        repeat(3) { frameNum ->
    ...
    fun whenMultipleDifferentObjectsScanned_thenAllAddedCorrectly() = runTest {
        ...
        val allConfirmed = mutableListOf<com.example.objecta.tracking.ObjectCandidate>()
        repeat(3) { frameNum ->
    ...
    private fun convertToScannedItem(candidate: com.example.objecta.tracking.ObjectCandidate): ScannedItem {
        return ScannedItem(
