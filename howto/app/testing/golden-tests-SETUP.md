...
If you need to keep changes, commit them in the dataset repo or stash them before updating the
pointer.
...
- Failures print a per-image report: subtype, image, pass/fail, predicted subtype, score, and
  missing attributes.
