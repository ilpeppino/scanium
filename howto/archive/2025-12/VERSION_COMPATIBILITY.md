...
**Root Cause**: `shared/core-tracking/build.gradle.kts` declared
`kotlin("plugin.serialization") version "1.9.20"` while root project used Kotlin 2.0.0.
...
1.
Check [Kotlin/AGP compatibility matrix](https://kotlinlang.org/docs/gradle-configure-project.html)
