...
- Only blocks screenshots on sensitive screens (camera screen remains unprotected for user
  convenience)
...
3. **Camera Screen (should NOT be protected):**
    ...
    - Attempt to take screenshot
    - **Expected:** Screenshot SUCCEEDS (camera screen intentionally not protected for user
      convenience)
