...
- ❌ `import com.scanium.app.tracking.ObjectTracker` → should be
  `com.scanium.core.tracking.ObjectTracker`
- ❌ `import com.scanium.app.aggregation.ItemAggregator` → should be
  `com.scanium.core.tracking.ItemAggregator`
...
1. Update all `import com.scanium.app.ml.ItemCategory` →
   `import com.scanium.core.models.ml.ItemCategory`
2. Update all `import com.scanium.app.items.ScannedItem` →
...
4. For ItemsViewModelAggregationTest: Extract pure aggregation tests to KMP, keep ViewModel
   orchestration tests
