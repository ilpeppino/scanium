...
Fixed two critical issues preventing Grafana Alloy from functioning correctly after container restarts:
...
**Root Causes:**
1. Alloy storage path `/var/lib/alloy/data` was not mounted persistently → lost tail positions on restart
