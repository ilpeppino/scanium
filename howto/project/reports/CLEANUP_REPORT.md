...
- Reduced the canonical doc set to six files and archived legacy/duplicate content under
  `docs/_archive/2025-12/` with banner notes.
- Refreshed core docs (INDEX, ARCHITECTURE, DEV_GUIDE, PRODUCT, DECISIONS) to match current Gradle
  versions, BuildConfig flags, and workflow behavior.
...
- Add new scripts under `scripts/` and document them in `scripts/README.md`; move deprecated scripts
  to `scripts/_archive/YYYY-MM/`.
