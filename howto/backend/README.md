...
| Folder                   | Contents                                     |
|--------------------------|----------------------------------------------|
| [deploy/](deploy/)       | Deployment procedures and configuration      |
| [reference/](reference/) | API docs, feature specs, architecture guides |
...
- `check-status.sh` - Check backend status
