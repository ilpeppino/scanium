...
**Location**: `/Users/family/dev/scanium/androidApp/src/main/java/com/scanium/app/MainActivity.kt:63`
...
2. **Source Code Has MARKETPLACE**: Confirmed in `/Users/family/dev/scanium/backend/src/modules/assistant/routes.ts:94`
...
4. **Other Tones Work**: FRIENDLY and PROFESSIONAL pass validation, proving basic schema validation is working
...
**Path**: `/Users/family/dev/scanium/androidApp/src/main/java/com/scanium/app/selling/assistant/AssistantRepository.kt`
...
### Production NAS
- Host: 192.168.178.45 (ilpeppino@nas)
...
The mystery is: **Static file grep shows MARKETPLACE in schema, but runtime validation rejects it**. This is almost certainly a deployment issue (wrong container image, multiple instances, or caching) rather than a code issue.
