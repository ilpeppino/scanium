***REMOVED*** Incident Report: HTTP 502 Bad Gateway
...
***REMOVED******REMOVED******REMOVED*** Immediate Fix
...
***REMOVED******REMOVED******REMOVED*** Permanent Fix
...
networks:
  ...
  - compose_scanium_net
  - scanium_net  ***REMOVED*** Added to resolve scanium-backend hostname
...
***REMOVED******REMOVED*** Follow-up: Preflight 401 Unauthorized (same day)
...
```bash
***REMOVED*** Confirm env var is set
