...
# Create symlink to .env in repo directory for docker-compose variable substitution
# This allows docker-compose to substitute ${CLOUDFLARED_TOKEN} in the command
