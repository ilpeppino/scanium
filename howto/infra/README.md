...
| Folder | Contents |
|--------|----------|
| [deploy/](deploy/) | NAS and container deployment guides |
| [incidents/](incidents/) | Infrastructure incident reports |
...
- `smoke.sh` - Smoke test infrastructure
- `docker_status.sh` - Check Docker container status
