...
│   ├── data/        # EbayApi, MockEbayApi, EbayMarketplaceService, ListingRepository
│   ├── domain/      # Listing, ListingDraft, ListingStatus, ListingCondition, ListingImage
│   ├── ui/          # SellOnEbayScreen, ListingViewModel, DebugSettingsDialog
│   └── util/        # ListingImagePreparer, ListingDraftMapper
...
### 7. eBay Selling Integration (`selling/`)
