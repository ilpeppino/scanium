...
- **scanium_background.svg** — Subtle blue gradient background for adaptive icons (matches brand primary color #0052cc).
...
- **Dark theme compatibility**: Icon background (#0052cc) works well on light status bars; notification icon (white) works on dark bars.
