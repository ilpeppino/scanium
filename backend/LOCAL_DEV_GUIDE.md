...
```json
{
  "authorizeUrl": "https://auth.sandbox.ebay.com/oauth2/authorize?client_id=Giuseppe-scanium-SBX-4e06b92ff-cac0b68f&redirect_uri=https%3A%2F%2Fbrayan-vizarded-undomestically.ngrok-free.dev%2Fauth%2Febay%2Fcallback&response_type=code&scope=https%3A%2F%2Fapi.ebay.com%2Foauth%2Fapi_scope..."
}
```
