...
data class ScanRoi(
     ...
     */
    fun containsBoxCenter(boxCenterX: Float, boxCenterY: Float): Boolean {
     ...
     */
    fun centerScore(boxCenterX: Float, boxCenterY: Float): Float {
     ...
     */
    fun iouWith(boxLeft: Float, boxTop: Float, boxRight: Float, boxBottom: Float): Float {
     ...
     */
    fun overlapRatio(boxLeft: Float, boxTop: Float, boxRight: Float, boxBottom: Float): Float {
        val intersectLeft = maxOf(left, boxLeft)
        val intersectTop = maxOf(top, boxTop)
        val intersectRight = minOf(right, boxRight)
        val intersectBottom = minOf(bottom, boxBottom)
    ...
    companion object {
         ...
         */
        fun forAspectRatio(previewAspectRatio: Float, baseSize: Float = 0.65f): ScanRoi {
