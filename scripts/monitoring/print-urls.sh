...
***REMOVED*** Scanium Monitoring Stack - Print Access URLs
***REMOVED*** Displays URLs, health status, and quick tips
...
***REMOVED*** Detect local IP address for LAN access (useful for testing from mobile devices)
detect_lan_ip() {
...
***REMOVED*** Check if monitoring stack is running
...
***REMOVED*** OTLP ingestion endpoints
...
***REMOVED*** Backend storage endpoints (localhost only)
...
***REMOVED*** Alloy UI (localhost only)
...
***REMOVED*** Health summary
echo -e "${GREEN}╔═══════════════════════════════════════════════════════════════╗"
echo "║          Quick Health Check                                   ║"
echo "╚═══════════════════════════════════════════════════════════════╝${NC}"
echo ""

***REMOVED*** Count healthy services
TOTAL_SERVICES=5
HEALTHY_COUNT=0
