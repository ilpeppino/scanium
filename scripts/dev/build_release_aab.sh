...
#   --release-notes "NOTES"   Release notes for Google Play Console
...
#   ./scripts/dev/build_release_aab.sh --release-notes "Bug fixes and improvements"
...
# Update local.properties with new version values
...
for flavor in "${FLAVORS[@]}"; do
    # Capitalize first letter for Gradle task name (portable for macOS/Linux)
...
# Commit and push version.properties
