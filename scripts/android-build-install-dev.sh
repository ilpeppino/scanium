...
***REMOVED*** Scanium Android Build & Install Script (Dev Debug)
***REMOVED***
***REMOVED*** Purpose: Build and install the devDebug variant of the Android app,
***REMOVED***          displaying the final BuildConfig values for verification.
***REMOVED***
***REMOVED*** Usage:
***REMOVED***   ./scripts/android-build-install-dev.sh [OPTIONS]
***REMOVED***
***REMOVED*** Options:
***REMOVED***   --build-only    Only build, don't install
***REMOVED***   --install-only  Only install (assumes already built)
***REMOVED***   --clean         Run clean before building
***REMOVED***   --help          Show this help message
***REMOVED***
***REMOVED*** Requirements:
***REMOVED***   - Android device connected via USB (for install)
***REMOVED***   - Backend configured in local.properties or environment
***REMOVED***
***REMOVED*** Example:
***REMOVED***   ./scripts/android-build-install-dev.sh
***REMOVED***   ./scripts/android-build-install-dev.sh --clean
***REMOVED***   ./scripts/android-build-install-dev.sh --build-only
***REMOVED***
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***
...
***REMOVED*** Step 2: Clean if requested
if [ "$CLEAN" = true ]; then
    echo ""
...
***REMOVED*** Step 4: Print BuildConfig values
echo ""
...
if [ -f "$BUILDCONFIG_PATH" ]; then
    ***REMOVED*** Extract and display relevant BuildConfig fields
    ...
    ***REMOVED*** Mask API key
    if [ -z "$API_KEY" ]; then
        MASKED_KEY="(not set)"
    elif [ ${***REMOVED***API_KEY} -le 8 ]; then
        MASKED_KEY="***"
    else
