...
# Configuration matches generate_assets.py
SIZE = 1024
COLORS = {
    "blue": "#1F4BFF",
    "yellow": "#FFD400",
...
def update_mipmap_xml(filename):
    ...
    if "monochrome" not in content:
        # Add monochrome before </adaptive-icon>
...
def main():
    ...
    # Monochrome: use white. Android tints it.
    generate_vector_xml("ic_launcher_monochrome.xml", "#FFFFFFFF", "#FFFFFFFF", is_monochrome=True)
