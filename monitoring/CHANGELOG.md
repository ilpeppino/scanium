# Scanium Monitoring Stack Changelog
...
### Added
- **Spanmetrics connector** (GH-408): Alloy now generates `traces_spanmetrics_*` metrics from trace spans
  - `traces_spanmetrics_calls_total` - counter of span calls by service, span name, kind, and status
