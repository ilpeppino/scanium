...
| [App Health](***REMOVED***app-health-mobile) | `scanium-app-health` | Mobile app functional correctness | Loki |
...
***REMOVED******REMOVED******REMOVED*** Backend HTTP Metrics (OpenTelemetry Semantic Conventions)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Primary Metric: `http_server_request_duration_seconds`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Saturation Metric: `http_server_active_requests`
...
***REMOVED******REMOVED******REMOVED*** Trace Span Metrics (Tempo-generated)

Tempo's metrics generator exports span metrics to Mimir.

***REMOVED******REMOVED******REMOVED******REMOVED*** Metric: `traces_spanmetrics_latency`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Metric: `traces_spanmetrics_calls_total`
...
***REMOVED******REMOVED******REMOVED******REMOVED*** Mobile App Logs
