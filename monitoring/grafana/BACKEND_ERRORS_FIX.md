...
The "Scanium - Backend Errors" dashboard panel ***REMOVED***2 "Total Errors (1h)" was missing the `or vector(0)` fallback in its PromQL query. When no error data existed or Mimir returned empty results, the panel showed "No data" instead of showing 0.
