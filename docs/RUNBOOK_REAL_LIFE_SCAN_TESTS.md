...
***REMOVED******REMOVED*** 1. Architecture Evaluation

***REMOVED******REMOVED******REMOVED*** 1.1 Live Scanning Pipeline
...
***REMOVED******REMOVED******REMOVED*** 1.2 Picture Capture Pipeline
...
***REMOVED******REMOVED******REMOVED*** 1.3 Scan vs Picture Divergence Points
...
***REMOVED******REMOVED******REMOVED*** 1.4 Likely Failure Points
...
***REMOVED******REMOVED*** 2. MUST-Pass Real-Life Test Criteria

***REMOVED******REMOVED******REMOVED*** Criterion 1: Single Object Lock at Optimal Distance
...
***REMOVED******REMOVED******REMOVED*** Criterion 2: Near Object Prioritized Over Background
...
***REMOVED******REMOVED******REMOVED*** Criterion 3: Panning Does Not Add Background Items
...
***REMOVED******REMOVED******REMOVED*** Criterion 4: ROI Boundary Enforced
...
***REMOVED******REMOVED******REMOVED*** Criterion 5: Too Close/Too Far States Trigger
...
***REMOVED******REMOVED******REMOVED*** Criterion 6: Lock Persists Through Minor Tremor
...
***REMOVED******REMOVED******REMOVED*** TEST-001: Single Object Optimal Distance Lock
...
***REMOVED******REMOVED******REMOVED*** TEST-002: Single Object Too Close Boundary
...
***REMOVED******REMOVED******REMOVED*** TEST-003: Two Objects - Center Priority Selection
...
***REMOVED******REMOVED******REMOVED*** TEST-004: Slow Pan - No Background Adds
...
***REMOVED******REMOVED******REMOVED*** TEST-005: Cluttered Background - ROI Strict Enforcement
...
***REMOVED******REMOVED******REMOVED*** Guidance States
| State | Visual | Hint |
|-------|--------|------|
...
***REMOVED******REMOVED******REMOVED*** Key Thresholds
