...
***REMOVED******REMOVED*** Phases Summary
...
***REMOVED******REMOVED*** Phase 2: Foundation Setup
...
***REMOVED******REMOVED******REMOVED*** Task 2.1: Create `shared:core-domain` Module
...
***REMOVED******REMOVED******REMOVED*** Task 2.2: Create `shared:core-data` Module
...
***REMOVED******REMOVED******REMOVED*** Task 2.3: Implement Module Dependency Validation
...
3. Update GitHub Actions workflow:
   ```yaml
   ***REMOVED*** .github/workflows/android-debug-apk.yml
...
```bash
./gradlew checkModuleDependencies
***REMOVED*** Should pass (no violations in current state)
...
***REMOVED******REMOVED******REMOVED*** Phase 2 Checklist
...
***REMOVED******REMOVED*** Phase 3: Shared Domain Creation
...
***REMOVED******REMOVED******REMOVED*** Task 3.1: Define Domain Models
...
***REMOVED******REMOVED******REMOVED*** Task 3.2: Define Repository Interfaces
...
***REMOVED******REMOVED******REMOVED*** Phase 3 Checklist
...
***REMOVED******REMOVED*** Phase 4: Use Case Extraction
...
***REMOVED******REMOVED******REMOVED*** Task 4.1: Extract `EstimatePriceUseCase` (Simplest First)
...
./gradlew assembleDebug
./gradlew test  ***REMOVED*** All tests including androidApp
```

---

***REMOVED******REMOVED******REMOVED*** Task 4.2: Extract `AggregateDetectionsUseCase`
...
./gradlew test
./gradlew assembleDebug
***REMOVED*** Run app, verify detection still works
```

---

***REMOVED******REMOVED******REMOVED*** Task 4.3: Extract `ClassifyStableItemUseCase`
...
***REMOVED******REMOVED******REMOVED*** Phase 4 Checklist
...
***REMOVED******REMOVED*** Phase 5: Cloud Classification Setup
...
***REMOVED******REMOVED******REMOVED*** Task 5.1: Define Backend API Contract
...
```markdown
***REMOVED*** Classification API Specification
...
***REMOVED******REMOVED******REMOVED*** Task 5.2: Implement Android Cloud Classification Client
...
```bash
./gradlew assembleDebug
***REMOVED*** Cloud classification disabled in debug builds (no backend needed yet)
```

---

***REMOVED******REMOVED******REMOVED*** Task 5.3: Wire Up Cloud Classification in ItemsViewModel
...
./gradlew test
./gradlew assembleDebug
***REMOVED*** Run app, verify items are added immediately (not blocked by classification)
```

---

***REMOVED******REMOVED******REMOVED*** Phase 5 Checklist
...
***REMOVED******REMOVED*** Phase 6: Configuration & Observability
...
***REMOVED******REMOVED******REMOVED*** Task 6.1: Create `shared:core-config` Module
...
***REMOVED******REMOVED******REMOVED*** Task 6.2: Add Observability Layer
...
```bash
./gradlew assembleDebug
***REMOVED*** Run app in debug mode, verify logs appear
```

---

***REMOVED******REMOVED******REMOVED*** Phase 6 Checklist
...
***REMOVED******REMOVED*** Phase 7: Cleanup & Validation
...
***REMOVED******REMOVED******REMOVED*** Task 7.1: Remove Deprecated Modules
...
***REMOVED******REMOVED******REMOVED*** Task 7.2: Run Full Architecture Validation

**Checklist:**
```bash
***REMOVED*** 1. Module dependency rules
./gradlew checkModuleDependencies

***REMOVED*** 2. Portable modules check
./gradlew checkPortableModules

***REMOVED*** 3. All tests pass
./gradlew test
./gradlew connectedAndroidTest  ***REMOVED*** Requires device

***REMOVED*** 4. Build succeeds
./gradlew assembleDebug
./gradlew assembleRelease

***REMOVED*** 5. No warnings
./gradlew build --warning-mode=all
```

---

***REMOVED******REMOVED******REMOVED*** Task 7.3: Documentation Updates
...
***REMOVED******REMOVED******REMOVED*** Phase 7 Checklist
...
***REMOVED******REMOVED*** Rollback Strategy
...
***REMOVED******REMOVED*** Parallel Work Streams
...
***REMOVED******REMOVED*** Post-Refactoring
