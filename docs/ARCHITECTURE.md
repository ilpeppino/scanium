...
***REMOVED******REMOVED*** Current State (Verified from Code)

***REMOVED******REMOVED******REMOVED*** Build System & Module Structure (as of Phase 0 Discovery)
...
***REMOVED******REMOVED******REMOVED*** Scanning Pipeline & ML Flow
...
***REMOVED******REMOVED******REMOVED*** Category Model & Assignment
...
***REMOVED******REMOVED******REMOVED*** Networking & Backend
...
***REMOVED******REMOVED******REMOVED*** Data Models & State Management
...
***REMOVED******REMOVED******REMOVED*** UI Architecture
...
***REMOVED******REMOVED******REMOVED*** Documentation Inventory
...
***REMOVED******REMOVED******REMOVED*** iOS & Cross-Platform Preparation
...
***REMOVED******REMOVED******REMOVED*** Build & CI/CD
...
***REMOVED******REMOVED******REMOVED*** Key Architectural Constraints (Current)
...
***REMOVED******REMOVED*** Target Architecture (Android First, iOS Ready)
...
***REMOVED******REMOVED******REMOVED*** Architecture Layers

***REMOVED******REMOVED******REMOVED******REMOVED*** A) Presentation Layer (Platform UI)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** B) Platform Scanning Layer (Platform-specific)
...
├── CameraXManager.kt           ***REMOVED*** Camera lifecycle, preview, frame routing
└── FrameAnalyzer.kt            ***REMOVED*** ImageAnalysis.Analyzer contract

android-ml-mlkit/
├── MlKitObjectDetector.kt      ***REMOVED*** Wraps ML Kit Object Detection API
├── MlKitBarcodeScanner.kt      ***REMOVED*** Wraps ML Kit Barcode Scanning API
└── MlKitTextRecognizer.kt      ***REMOVED*** Wraps ML Kit Text Recognition API

androidApp/src/.../ml/
├── ObjectDetectorClient.kt     ***REMOVED*** Current: detection + tracking ID extraction
└── DetectionAdapter.kt         ***REMOVED*** Converts ML Kit DetectedObject → RawDetection
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** C) Core Domain Layer ("Shared Brain", KMP-ready)
...
**Module Structure:**
```
shared:core-domain/              ***REMOVED*** NEW MODULE (to be created)
└── src/commonMain/kotlin/
    ├── model/
    │   ├── ScannedItem.kt       ***REMOVED*** EXISTING (move from core-models)
    │   ├── AggregatedItem.kt    ***REMOVED*** EXISTING (move from core-tracking)
    │   ├── DomainCategoryId.kt  ***REMOVED*** NEW: fine-grained category ID
    │   ├── ItemAttributes.kt    ***REMOVED*** NEW: extracted attributes (color, brand, etc.)
    │   └── PriceEstimate.kt     ***REMOVED*** NEW: price range with confidence
    ├── usecase/
    ...
    └── repository/
        ├── ClassificationRepository.kt    ***REMOVED*** Interface
        ├── DomainPackRepository.kt       ***REMOVED*** EXISTING (move to shared)
        └── PricingRepository.kt          ***REMOVED*** Interface
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** D) Data Layer / Integrations (Cloud Classification)
...
```
shared:core-data/                ***REMOVED*** NEW MODULE (to be created)
└── src/
    ├── commonMain/kotlin/
    │   ├── repository/
    │   │   └── CloudClassificationRepository.kt   ***REMOVED*** Interface
    │   ├── model/
    │   │   ├── ClassificationRequest.kt
    │   │   └── ClassificationResponse.kt
    │   └── mapper/
    │       └── GoogleVisionMapper.kt              ***REMOVED*** API response → domain model
    ├── androidMain/kotlin/
    │   └── repository/
    │       └── GoogleVisionClassifierAndroid.kt   ***REMOVED*** Android HTTP client impl
    └── iosMain/kotlin/
        └── repository/
            └── GoogleVisionClassifierIOS.kt       ***REMOVED*** iOS URLSession impl
```
...
***REMOVED******REMOVED******REMOVED******REMOVED*** E) Configuration Layer
...
***REMOVED******REMOVED******REMOVED******REMOVED*** F) Observability Layer
...
***REMOVED******REMOVED******REMOVED*** Data Flow (End-to-End)
...
***REMOVED******REMOVED******REMOVED*** Module Dependency Graph (Target State)
...
***REMOVED******REMOVED*** Key flows (current Android implementation)
...
***REMOVED******REMOVED*** Where to look in code (truth sources)
...
***REMOVED******REMOVED*** Shared brain guardrails (KMP)
