...
Document the camera scanning pipeline boundaries, responsibilities, and invariants so changes to capture, analysis, and scanning remain safe.

***REMOVED******REMOVED*** Scope
- Android camera pipeline centered on `androidApp/src/main/java/com/scanium/app/camera/CameraXManager.kt`.
