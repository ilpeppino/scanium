...
This document describes the script infrastructure in the Scanium repository, including the Script Master launcher and all available development scripts.
...
The **Script Master** (`./script-master`) is an interactive menu-driven launcher for all Scanium scripts. It provides:
