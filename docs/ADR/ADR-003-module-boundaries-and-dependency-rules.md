...
### Option 1: No Formal Boundaries (Current State)
...
### Option 2: Strict Layer Architecture with Gradle Dependency Validation (**CHOSEN**)
...
### Option 3: Separate Git Repositories per Layer
...
#### **Rule 1: Presentation Layer Can Depend on Everything**
...
#### **Rule 2: Platform Modules Cannot Depend on Each Other**
...
#### **Rule 3: Shared Modules Cannot Depend on Platform Modules**
...
#### **Rule 4: Dependency Direction is Always Downward**
...
#### **Rule 5: Core-* Android Wrappers Are Deprecated (Phase Out)**
...
### Gradle Validation Implementation
...
# Add to test task for automatic validation
./gradlew test  # Now includes dependency check
```
...
## Appendix: Module Dependency Graph (Current State)
...
## Appendix: Module Dependency Graph (Target State - Phase 7)
...
# REMOVED: core-models, core-tracking (Android wrappers deprecated)
# MOVED TO SHARED: core-domainpack → shared:core-domain
```
