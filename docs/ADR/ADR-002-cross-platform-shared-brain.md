***REMOVED*** ADR-002: Cross-Platform "Shared Brain" Architecture with KMP
...
***REMOVED******REMOVED******REMOVED*** Option 1: Platform-Specific Codebases (Current State)
...
***REMOVED******REMOVED******REMOVED*** Option 2: Kotlin Multiplatform (KMP) for Shared Business Logic (**CHOSEN**)
...
***REMOVED******REMOVED******REMOVED*** Option 3: Full Cross-Platform Framework (Flutter/React Native)
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Layer 1: Platform-Specific (Android/iOS Diverge)**
...
***REMOVED******REMOVED******REMOVED******REMOVED*** **Layer 2: Shared Business Logic (KMP commonMain)**
...
***REMOVED******REMOVED******REMOVED*** KMP Migration Strategy
...
***REMOVED******REMOVED******REMOVED*** Platform Interface Boundaries
...
***REMOVED******REMOVED******REMOVED*** Dependency Injection Strategy
...
**Run tests:**
```bash
***REMOVED*** JVM tests (Android-compatible)
./gradlew shared:core-domain:testDebugUnitTest

***REMOVED*** iOS tests (future)
