# ADR-001: Cloud Classification via Google Vision API
...
### Option 1: Direct Google Vision API calls from mobile
...
### Option 2: Backend proxy with Google Vision (**CHOSEN**)
...
## Privacy & EU GDPR Considerations
...
### Minimal Data Retention (Default Configuration)
...
## Appendix: Alternative Google Vision Integration
