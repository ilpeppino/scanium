***REMOVED*** Scanium Backend Release and Rollback Guide
...
- [Image Tagging Strategy](***REMOVED***image-tagging-strategy)
- [Deploying a New Version](***REMOVED***deploying-a-new-version)
- [Rolling Back](***REMOVED***rolling-back)
...
***REMOVED******REMOVED*** Image Tagging Strategy
...
***REMOVED******REMOVED*** Deploying a New Version
