...
This guide explains how to profile camera analyzer latency, frame rate, and classification turnaround using the instrumentation added to Scanium.
...
- **Log Format**: `[METRICS] Classification turnaround for ITEM_ID: XXXms (mode=CLOUD/ON_DEVICE, status=SUCCESS/FAILED)`
