...
object DetectionGeometryMapper {
    ...
    fun cropAndRotateThumbnail(
        ...
        return try {
            ...
            val cropRect = sensorBboxToBitmapCrop(
                sensorBboxNorm,
                sourceBitmap.width,
                sourceBitmap.height,
                paddingRatio
    ...
    fun logDebug(
        ...
        if (topDetectionScreen != null) {
            Log.d(TAG, "Top detection (screen): " +
    ...
    fun validateMappedRect(
        ...
        val isValid = rect.left >= minX && rect.top >= minY &&
