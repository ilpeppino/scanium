...
object LiveScanDiagnostics {
    ...
    fun logCandidateSelection(
        ...
        Log.d(TAG, "[FRAME #$frameId] SELECT: id=$selectedId, score=${String.format("%.3f", selectedScore)}, " +
    ...
    fun logItemAdded(
        ...
        Log.i(TAG, "[FRAME #$frameId] ITEM_ADDED: id=$candidateId, cat=$category, " +
    ...
    fun logGatingRejection(
        ...
        Log.d(TAG, "[FRAME #$frameId] GATING_REJECT: id=$candidateId, reason=$reason, " +
    ...
    fun logStabilityState(
        ...
        Log.d(TAG, "[FRAME #$frameId] STABILITY: id=$candidateId, " +
    ...
    fun logSharpness(
        ...
        Log.d(TAG, "[FRAME #$frameId] SHARPNESS: score=${String.format("%.1f", sharpnessScore)}, " +
