...
Listing titles are generated from scanned items using a **single source of truth**: `ListingTitleBuilder`.
...
**Solution**: Ensure cloud classification is working and `enhancedLabelText` is populated in AggregatedItem.
