...
object LocalTemplatePacks {
    private val homePack = LocalTemplatePack(
        packId = "home",
    ...
    private val fashionPack = LocalTemplatePack(
        packId = "fashion",
    ...
    private val generalPack = LocalTemplatePack(
        packId = "general",
        displayName = "General",
