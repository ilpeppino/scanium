 ...
 */
@Singleton
class EnrichmentPolicy @Inject constructor(
     ...
     */
    fun getRemainingItemBudget(itemId: String, config: PolicyConfig = PolicyConfig()): Int {
    ...
    private fun getItemCount(itemId: String): Int {
        return prefs.getInt("$KEY_ITEM_PREFIX$itemId", 0)
    }
