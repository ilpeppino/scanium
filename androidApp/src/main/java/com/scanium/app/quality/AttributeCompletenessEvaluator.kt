...
object AttributeCompletenessEvaluator {
     ...
     */
    private val categoryRequirements: Map<ItemCategory, List<AttributeRequirement>> = mapOf(
        ItemCategory.FASHION to listOf(
        ...
        ItemCategory.HOME_GOOD to listOf(
     ...
     */
    private val defaultRequirements = listOf(
    ...
    fun getTopMissingAttributes(
        ...
        return result.missingAttributes.take(limit)
    }
    ...
    fun getNextPhotoGuidance(result: CompletenessResult): String? {
        return result.missingAttributes
    ...
    fun getRequirementsForCategory(category: ItemCategory): List<AttributeRequirement> {
        return categoryRequirements[category] ?: defaultRequirements
    }

    /**
     * Check if a specific attribute is required for a category.
     */
    fun isAttributeRequired(category: ItemCategory, attributeKey: String): Boolean {
        val requirements = categoryRequirements[category] ?: defaultRequirements
     ...
     */
    fun getAttributeImportance(category: ItemCategory, attributeKey: String): Int {
        val requirements = categoryRequirements[category] ?: defaultRequirements
