...
object ItemLocalizer {
     ...
     */
    @Composable
    fun getCategoryName(category: ItemCategory): String = stringResource(getCategoryStringRes(category))
    ...
    ): String = context.getString(getCategoryStringRes(category))
     ...
     */
    @Composable
    fun getConditionName(condition: ItemCondition): String = stringResource(getConditionStringRes(condition))
    ...
    ): String = context.getString(getConditionStringRes(condition))
     ...
     */
    @Composable
    fun getConditionDescription(condition: ItemCondition): String = stringResource(getConditionDescriptionStringRes(condition))

    /**
     * Get localized condition description from Context
     */
    fun getConditionDescription(
        context: Context,
        condition: ItemCondition,
    ): String = context.getString(getConditionDescriptionStringRes(condition))
     ...
     */
    @Composable
    fun getSourceLabel(source: String?): String = stringResource(getSourceStringRes(source))
    ...
    fun getSourceLabel(
        context: Context,
        source: String?,
    ): String = context.getString(getSourceStringRes(source))
    ...
    fun getSourceStringRes(source: String?): Int =
        when (source?.lowercase()) {
            "vision" -> {
                R.string.attribute_source_vision
            }

            "vision-color" -> {
                R.string.attribute_source_vision_color
            }

            "vision-logo" -> {
                R.string.attribute_source_vision_logo
            }

            "vision-label" -> {
                R.string.attribute_source_vision_label
            }

            "vision-ocr" -> {
                R.string.attribute_source_vision_ocr
            }

            "user" -> {
                R.string.attribute_source_user
            }

            "enrichment" -> {
                R.string.attribute_source_enrichment
            }

            null -> {
                R.string.attribute_source_unknown
            }
