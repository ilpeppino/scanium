 ...
 */
@Singleton
class PerItemDedupeHelper @Inject constructor() {
    companion object {
    ...
    fun computeHash(bitmap: Bitmap): String {
        return try {
            ...
            for (i in hashBits.indices step 4) {
                val nibble = (hashBits.getOrElse(i) { 0 } shl 3) or
     ...
     */
    fun isDuplicateForItem(hash: String, existingPhotos: List<ItemPhoto>): Boolean {
     ...
     */
    fun computeSimilarity(hash1: String, hash2: String): Float {
