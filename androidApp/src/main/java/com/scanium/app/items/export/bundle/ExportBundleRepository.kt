 ...
 */
@Singleton
class ExportBundleRepository @Inject constructor(
    ...
    fun buildBundles(
        ...
        val selectedItems = if (itemIds != null) {
     ...
     */
    private fun buildBundle(item: ScannedItem, photoUris: List<String>): ExportItemBundle {
 ...
 */
class ExportLimitExceededException(message: String) : Exception(message)
