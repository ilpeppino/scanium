...
class ItemsViewModelInstrumentedTest {
    ...
    @Test
    fun whenAddingItemsOnAndroid_thenStateFlowEmitsCorrectly() =
        runBlocking {
            // Arrange
            val item =
                ScannedItem(
    ...
    @Test
    fun whenConcurrentAdditions_thenAllItemsSafelyAdded() =
        runBlocking {
    ...
    @Test
    fun whenViewModelCreatedWithPersistedItems_thenItemsAreLoaded() =
        runBlocking {
    ...
    @Test
    fun whenRemovingAndReAdding_thenItemAppearsAgain() =
        runBlocking {
            // Arrange
    ...
    @Test
    fun whenItemsCleared_thenNewViewModelStartsEmpty() =
        runBlocking {
