...
class CameraLifecycleRegressionTest {
    ...
    @Test
    fun testCameraPipelineStartup_ReceivesFrames() =
        runTest {
    ...
    @Test
    fun testCameraAfterNavigation_ResumesWithoutFreeze() =
        runTest {
            // Wait for app to initialize
            delay(1000)
    ...
    @Test
    fun testCameraPipelineDiagnostics_ShowsValidState() =
        runTest {
    ...
    @Test
    fun testMultipleNavigationCycles_NoPipelineFreeze() =
        runTest {
