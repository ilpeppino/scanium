...
class ItemsViewModelTest {
    ...
    @Test
    fun whenViewModelCreated_thenItemsListIsEmpty() =
        runTest {
            // Act
    ...
    @Test
    fun whenAddingSingleItem_thenItemAppearsInList() =
        runTest {
            // Arrange
    ...
    @Test
    fun whenAddingMultipleItems_thenAllItemsAppear() =
        runTest {
            // Arrange
            val items =
                listOf(
    ...
    @Test
    fun whenAddingDuplicateItem_thenOnlyOneInstanceKept() =
        runTest {
            // Arrange
    ...
    @Test
    fun whenAddingItemsWithDuplicateIds_thenDuplicatesFiltered() =
        runTest {
            // Arrange
            val items =
                listOf(
                    ...
                    createTestItem(id = "item-2", category = ItemCategory.ELECTRONICS),
                    createTestItem(id = "item-1", category = ItemCategory.FASHION),
// Duplicate (same category for merge)
                )
    ...
    @Test
    fun whenRemovingItem_thenItemDisappearsFromList() =
        runTest {
            // Arrange
    ...
    @Test
    fun whenRemovingNonExistentItem_thenListUnchanged() =
        runTest {
            // Arrange
            viewModel.addItem(createTestItem(id = "item-1", category = ItemCategory.FASHION))
    ...
    @Test
    fun whenClearingAllItems_thenListBecomesEmpty() =
        runTest {
            // Arrange
            viewModel.addItem(createTestItem(id = "item-1", category = ItemCategory.FASHION))
            viewModel.addItem(createTestItem(id = "item-2", category = ItemCategory.ELECTRONICS))
    ...
    @Test
    fun whenClearingEmptyList_thenNoError() =
        runTest {
            // Act
            viewModel.clearAllItems()
    ...
    @Test
    fun whenAddingAfterClearing_thenNewItemsAppear() =
        runTest {
            // Arrange
            viewModel.addItem(createTestItem(id = "item-1", category = ItemCategory.FASHION))
            viewModel.clearAllItems()
    ...
    @Test
    fun whenAddingSameItemAfterRemoval_thenItemCanBeAddedAgain() =
        runTest {
            // Arrange
            val item = createTestItem(id = "item-1", category = ItemCategory.FASHION)
            viewModel.addItem(item)
    ...
    @Test
    fun whenAddingItemsSequentially_thenMaintainsOrder() =
        runTest {
            // Act
            viewModel.addItem(createTestItem(id = "item-1", category = ItemCategory.FASHION))
            viewModel.addItem(createTestItem(id = "item-2", category = ItemCategory.ELECTRONICS))
    ...
    @Test
    fun whenAddingEmptyList_thenNoChange() =
        runTest {
            // Arrange
            viewModel.addItem(createTestItem(id = "item-1", category = ItemCategory.FASHION))
    ...
    @Test
    fun whenAddingMixOfNewAndDuplicateItems_thenOnlyNewOnesAdded() =
        runTest {
            ...
            viewModel.addItems(
                listOf(
                    createTestItem(id = "item-1", category = ItemCategory.FASHION),
// Duplicate (merge)
                    createTestItem(id = "item-2", category = ItemCategory.HOME_GOOD),
// New
                    createTestItem(id = "item-3", category = ItemCategory.PLANT),
// New
                ),
            )
    ...
    @Test
    fun whenAddingItemsWithDifferentConfidenceLevels_thenAllStored() =
        runTest {
            // Arrange
            val items =
                listOf(
    ...
    @Test
    fun whenItemCountQueried_thenMatchesActualListSize() =
        runTest {
            // Act & Assert - Empty
            assertThat(viewModel.getItemCount()).isEqualTo(0)
    ...
    @Test
    fun whenCreatingExportPayload_thenUsesSelectedItems() =
        runTest {
            // Arrange
            viewModel.addItems(
                listOf(
    ...
    @Test
    fun whenAddingSimilarItemWithDifferentId_thenRejectedBySimilarityCheck() =
        runTest {
...
// Similar size
    ...
    @Test
    fun whenAddingDissimilarItems_thenBothAdded() =
        runTest {
...
// Different category
    ...
    @Test
    fun whenAddingItemsWithoutDistinguishingFeatures_thenBothAdded() =
        runTest {
            ...
            val item2 =
                createTestItem(
                    id = "item-2",
                    category = ItemCategory.FASHION,
// Same category but no thumbnail
                    boundingBox = defaultBoundingBox(offsetX = 0.5f),
// Spatially separated
                )
            viewModel.addItem(item2)
    ...
    @Test
    fun whenAddingBatchWithSimilarItems_thenOnlyUniqueOnesAdded() =
        runTest {
            // Arrange - Add initial item
            val existingItem =
                createItemWithThumbnail(
...
// Different category
    ...
    @Test
    fun whenAddingBatchWithInternalSimilarItems_thenFirstOccurrenceKept() =
        runTest {
...
// Similar to item-1 and item-2
    ...
    @Test
    fun whenClearingItems_thenSessionDeduplicatorReset() =
        runTest {
            // Arrange - Add item
            val item1 =
                createItemWithThumbnail(
...
// Similar to item-1
    ...
    @Test
    fun whenRemovingItem_thenCanAddSimilarItemAgain() =
        runTest {
...
// Similar to removed item-1
    ...
    @Test
    fun whenSamePhysicalObjectDetectedWithDifferentTrackingIds_thenOnlyOneKept() =
        runTest {
...
// Different tracking ID
                    category = ItemCategory.FASHION,
                    thumbnailWidth = 205,
// Slightly different (camera moved)
                    thumbnailHeight = 205,
                )
    ...
    @Test
    fun whenMultipleDifferentObjectsScanned_thenAllAdded() =
        runTest {
    ...
    @Test
    fun whenAddingSimilarItemsWithDifferentSizes_thenOnlyDissimilarOnesAdded() =
        runTest {
...
// Size difference > 40% - dissimilar
    ...
    private fun defaultBoundingBox(
        size: Float = 0.2f,
        offsetX: Float = 0.0f,
        offsetY: Float = 0.0f,
    ): NormalizedRect {
    ...
    @Test
    fun whenViewModelCreated_thenThresholdIsDefault() =
        runTest {
    ...
    @Test
    fun whenUpdatingThreshold_thenStateFlowEmitsNewValue() =
        runTest {
    ...
    @Test
    fun whenUpdatingThresholdToZero_thenAcceptsValue() =
        runTest {
            // Act - Set to minimum
    ...
    @Test
    fun whenUpdatingThresholdToOne_thenAcceptsValue() =
        runTest {
            // Act - Set to maximum
    ...
    @Test
    fun whenUpdatingThresholdAboveOne_thenClampsToOne() =
        runTest {
    ...
    @Test
    fun whenUpdatingThresholdBelowZero_thenClampsToZero() =
        runTest {
    ...
    @Test
    fun whenUpdatingThresholdMultipleTimes_thenAlwaysReflectsLatest() =
        runTest {
    ...
    @Test
    fun whenGettingCurrentThreshold_thenMatchesStateFlow() =
        runTest {
    ...
    @Test
    fun whenThresholdUpdated_thenAggregatorUsesNewValue() =
        runTest {
    ...
    @Test
    fun whenLowerThreshold_thenMoreItemsMerged() =
        runTest {
    ...
    @Test
    fun whenHigherThreshold_thenFewerItemsMerged() =
        runTest {
    ...
    @Test
    fun whenThresholdChangedDuringScanning_thenImmediatelyAffectsNewDetections() =
        runTest {
