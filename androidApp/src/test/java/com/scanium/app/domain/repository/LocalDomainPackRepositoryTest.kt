...
class LocalDomainPackRepositoryTest {
    ...
    @Test
    fun `getActiveDomainPack returns valid pack`() = runTest {
    ...
    @Test
    fun `getActiveDomainPack caches result on repeated calls`() = runTest {
    ...
    @Test
    fun `loaded pack has valid category structure`() = runTest {
        val pack = repository.getActiveDomainPack()
    ...
    @Test
    fun `loaded pack has valid attribute structure`() = runTest {
        val pack = repository.getActiveDomainPack()
    ...
    @Test
    fun `all categories have valid enabled flags`() = runTest {
        val pack = repository.getActiveDomainPack()
    ...
    @Test
    fun `all categories have valid itemCategoryName values`() = runTest {
        val pack = repository.getActiveDomainPack()
    ...
    @Test
    fun `all categories have non-empty prompts`() = runTest {
        val pack = repository.getActiveDomainPack()
    ...
    @Test
    fun `all category IDs are unique`() = runTest {
        val pack = repository.getActiveDomainPack()
    ...
    @Test
    fun `clearCache resets cached pack`() = runTest {
        val pack1 = repository.getActiveDomainPack()
    ...
    @Test
    fun `loaded pack has correct structure`() = runTest {
        val pack = repository.getActiveDomainPack()
    ...
    @Test
    fun `attributes reference valid category IDs`() = runTest {
        val pack = repository.getActiveDomainPack()
