...
class BasicCategoryEngineTest {
    ...
    @Test
    fun `selectCategory returns null when mlKitLabel is null`() = runTest {
    ...
    @Test
    fun `selectCategory returns null when mlKitLabel is empty`() = runTest {
    ...
    @Test
    fun `selectCategory matches exact display name`() = runTest {
    ...
    @Test
    fun `selectCategory is case insensitive`() = runTest {
    ...
    @Test
    fun `selectCategory matches substring`() = runTest {
    ...
    @Test
    fun `selectCategory prefers higher priority on multiple matches`() = runTest {
    ...
    @Test
    fun `selectCategory ignores disabled categories`() = runTest {
        // Create pack with a disabled category
        val packWithDisabled = testPack.copy(
            categories = testPack.categories.map {
    ...
    @Test
    fun `selectCategory returns null when no matches found`() = runTest {
    ...
    @Test
    fun `getCandidateCategories returns empty list for null label`() = runTest {
        val input = CategorySelectionInput(mlKitLabel = null)
    ...
    @Test
    fun `getCandidateCategories returns scored matches`() = runTest {
        val input = CategorySelectionInput(mlKitLabel = "electronics")
    ...
    @Test
    fun `getCandidateCategories sorts by score descending`() = runTest {
        val input = CategorySelectionInput(mlKitLabel = "laptop")
    ...
    @Test
    fun `selectCategory handles whitespace in labels`() = runTest {
        val input = CategorySelectionInput(mlKitLabel = "  Laptop  ")
    ...
    @Test
    fun `selectCategory matches real ML Kit labels`() = runTest {
        // Test with labels that actually match our test data structure
        val testCases = listOf(
            "furniture" to "furniture",     // Matches parentId "furniture"
            "shoes" to "clothing_shoes",     // Matches displayName "Shoes"
            "electronics" to "electronics"   // Matches parentId "electronics"
        )
