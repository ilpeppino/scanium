...
class BillingRepositoryTest {
    ...
    @Test
    fun `updateEntitlement persists correct state`() =
        testScope.runTest {
            // Given
    ...
    @Test
    fun `clearEntitlement resets to FREE tier`() =
        testScope.runTest {
    ...
    @Test
    fun `purchase tokens are deduplicated`() =
        testScope.runTest {
    ...
    @Test
    fun `corrupted preferences fall back to FREE`() =
        testScope.runTest {
