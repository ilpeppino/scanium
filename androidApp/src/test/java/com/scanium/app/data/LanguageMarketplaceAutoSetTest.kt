...
class LanguageMarketplaceAutoSetTest {
    ...
    @Test
    fun `setting Dutch language auto-sets marketplace to Netherlands`() = runTest {
    ...
    @Test
    fun `setting German language auto-sets marketplace to Germany`() = runTest {
    ...
    @Test
    fun `setting French language auto-sets marketplace to France`() = runTest {
    ...
    @Test
    fun `setting English language auto-sets marketplace to UK`() = runTest {
    ...
    @Test
    fun `setting Brazilian Portuguese language auto-sets marketplace to UK (unsupported)`() = runTest {
    ...
    @Test
    fun `manual marketplace country selection sets custom override`() = runTest {
    ...
    @Test
    fun `language change clears manual marketplace override and re-applies mapping`() = runTest {
    ...
    @Test
    fun `changing from supported to unsupported language sets marketplace to UK`() = runTest {
    ...
    @Test
    fun `effective marketplace country returns correct value after language change`() = runTest {
    ...
    @Test
    fun `effective marketplace country respects manual override before language change`() = runTest {
    ...
    @Test
    fun `case insensitive language tags work correctly`() = runTest {
