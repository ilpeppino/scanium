...
fun RectF.toNormalizedRect(frameWidth: Int, frameHeight: Int): NormalizedRect {
...
fun Rect.toNormalizedRect(frameWidth: Int, frameHeight: Int): NormalizedRect {
    requirePositiveDimensions(frameWidth, frameHeight)
...
fun NormalizedRect.toRectF(frameWidth: Int, frameHeight: Int): RectF {
    requirePositiveDimensions(frameWidth, frameHeight)
...
fun NormalizedRect.toRect(frameWidth: Int, frameHeight: Int): Rect {
    requirePositiveDimensions(frameWidth, frameHeight)
    val clamped = clampToUnit()
    return Rect(
