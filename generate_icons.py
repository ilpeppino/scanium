...
def create_launcher_icon(width, height):
    ...
    bg = Image.new('RGB', (width, height), '#0052cc')
    img.paste(bg, (0, 0))
    ...
    # Draw curved S between them (simplified)
...
def create_playstore_icon(width, height):
    ...
    img = Image.new('RGB', (width, height), '#0052cc')
    draw = ImageDraw.Draw(img)
    ...
    # Upper lens - solid with gradient effect
    upper_y = center_y - lens_radius - y_offset
    lens_box = [
    ...
    # Draw filled lens with gradients (simplified)
